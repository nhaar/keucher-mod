...
if (global.bboxVisible > 0)
{
    ...
    if (global.bboxVisible == 2)
    {
        ...
        if i_ex(obj_chaseenemy_ch1)
        {
            ...
            {
                for (i = 0; i < instance_number(obj_chaseenemy_ch1); i++)
                {
        ...
        if i_ex(obj_interactable_ch1)
        {
            ...
            {
                for (i = 0; i < instance_number(obj_interactable_ch1); i++)
                {
        ...
        if i_ex(obj_solidblock_ch1)
        {
            with (obj_solidblock_ch1)
            {
                for (i = 0; i < instance_number(obj_solidblock_ch1); i++)
                {
                    ...
                    if (sblock.object_index == obj_sur_dark_ch1 || sblock.object_index == obj_sur_ch1 || sblock.object_index == obj_sul_ch1 || sblock.object_index == obj_sdr_ch1 || sblock.object_index == obj_sdl_dark_ch1 || sblock.object_index == obj_sdl_ch1)
                    {
                    }
                    else
