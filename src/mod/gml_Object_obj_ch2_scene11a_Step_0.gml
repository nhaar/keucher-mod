...
if (con == 2 && customcon == 0)
{
    ...
    if shortened
    {
        con = 11
        tempcon = 0
        c_var_instance(coaster_berdly, "character_sprite", 1850)
    ...
    else
    {
        ...
        c_var_instance(coaster_ralsei, "character_sprite", 786)
        c_speaker("ralsei")
        ...
        c_wait(10)
        c_var_instance(coaster_susie, "character_sprite", 846)
        c_var_instance(coaster_noelle, "character_sprite", 216)
        ...
        c_wait(30)
        c_var_instance(coaster_noelle, "character_sprite", 723)
        c_speaker("noelle")
        ...
        c_facenext("susie", "C")
        c_var_instance(coaster_susie, "character_sprite", 826)
        ...
        c_talk_wait()
        c_mus("free")
        c_var_instance(coaster_berdly, "character_sprite", 685)
        ...
        c_var_instance(coaster_noelle, "character_sprite", 718)
        c_waitcustom()
    }
}
...
if (con == 5)
{
    con = 6
    c_waitcustom_end()
    c_var_instance(coaster_susie, "character_sprite", 998)
    c_var_instance(coaster_ralsei, "character_sprite", 1511)
    c_speaker("berdly")
    ...
    c_talk_wait()
    c_var_instance(coaster_susie, "character_sprite", 46)
    c_var_instance(coaster_ralsei, "character_sprite", 797)
    c_mus("free_all")
    ...
    c_talk_wait()
    c_var_instance(coaster_berdly, "character_sprite", 696)
    c_speaker("berdly")
    ...
    c_talk_wait()
    c_var_instance(coaster_berdly, "character_sprite", 675)
    ...
    c_talk_wait()
    c_var_instance(coaster_berdly, "character_sprite", 163)
    c_speaker("berdly")
    ...
    c_sprite(spr_queen_chair_flame_side)
    c_wait(10)
    c_var_instance(coaster_berdly, "character_sprite", 671)
    c_speaker("ralsei")
...
if (con == 10)
{
    ...
    c_var_instance(coaster_berdly, "character_sprite", 666)
    c_var_instance(coaster_berdly, "character_offset_x", -52)
