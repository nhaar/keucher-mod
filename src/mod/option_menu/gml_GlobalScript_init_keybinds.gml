function init_keybinds()
{
    ...
    if (ds_map_empty(global.mod_keybinds))
    {
        ...
        ds_map_add(global.mod_keybinds, 11, vk_f11)
        ds_map_add(global.mod_keybinds, 12, vk_f12)
        ds_map_add(global.mod_keybinds, 13, vk_escape)
        ds_map_add(global.mod_keybinds, 14, ord("U"))
        ds_map_add(global.mod_keybinds, 15, ord("I"))
        ds_map_add(global.mod_keybinds, 16, ord("O"))
        ds_map_add(global.mod_keybinds, 17, ord("H"))
        ds_map_add(global.mod_keybinds, 18, ord("J"))
        ds_map_add(global.mod_keybinds, 19, ord("K"))
        ds_map_add(global.mod_keybinds, 20, ord("N"))
